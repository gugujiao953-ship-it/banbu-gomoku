...
try {
  ...
  assert((await page.locator(".unified-status .status-state").innerText()).includes("未保存草稿"), "落子后未进入草稿状态");
  ...
  assert((await page.locator(".unified-status .status-state").innerText()).includes("未保存草稿"), "另存为题库错误清除了源棋谱草稿");
