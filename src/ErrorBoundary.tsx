...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  private handleCopy = () => {
    ...
    void navigator.clipboard?.writeText(JSON.stringify({ message: error?.message, stack: error?.stack, componentStack: this.state.componentStack }, null, 2))
      ...
      <div className="error-boundary" role="alert">
        <div className="error-boundary-card">
          ...
          <div className="error-boundary-actions">
            <button type="button" className="primary-button" onClick={() => downloadDiagnostics(error, this.state.componentStack)}>导出诊断信息</button>
